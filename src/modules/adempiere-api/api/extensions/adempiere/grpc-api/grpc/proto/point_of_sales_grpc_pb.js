...
function serialize_data_CreateOrderFromRMARequest(arg) {
  if (!(arg instanceof proto_point_of_sales_pb.CreateOrderFromRMARequest)) {
    throw new Error('Expected argument of type data.CreateOrderFromRMARequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_data_CreateOrderFromRMARequest(buffer_arg) {
  return proto_point_of_sales_pb.CreateOrderFromRMARequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
createOrderFromRMA: {
    path: '/data.Store/CreateOrderFromRMA',
    requestStream: false,
    responseStream: false,
    requestType: proto_point_of_sales_pb.CreateOrderFromRMARequest,
    responseType: proto_point_of_sales_pb.Order,
    requestSerialize: serialize_data_CreateOrderFromRMARequest,
    requestDeserialize: deserialize_data_CreateOrderFromRMARequest,
    responseSerialize: serialize_data_Order,
    responseDeserialize: deserialize_data_Order,
  },
